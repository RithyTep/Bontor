      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-brand-card border border-white/10 rounded-2xl p-8">
          ...
          <p className="text-slate-400 text-center mb-8">
            Sign in to continue to Bontor
          </p>

          {/* Google Sign In */}
          <button className="w-full flex items-center justify-center gap-3 bg-white text-black font-semibold py-3 px-4 rounded-xl hover:bg-slate-100 transition-colors mb-4">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-brand-card text-slate-500">or</span>
            </div>
          </div>
          ...
          <p className="text-center text-slate-400 text-sm mt-6">
            ...
            <Link href="/auth/signup" className="text-brand-purple hover:underline">
              Sign up
            </Link>
          </p>
        </div>
